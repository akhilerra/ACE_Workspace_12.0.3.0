...
public class App_ValidateJWT_Token_mf_VlidateJWT_Token_Compute_0001_Test {

	/*
	 * App_ValidateJWT_Token_mf_VlidateJWT_Token_Compute_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.3.0 on Jun 17, 2024 5:42:09 PM
	 */
	...
	@Test
	public void App_ValidateJWT_Token_mf_VlidateJWT_Token_Compute_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("App_ValidateJWT_Token")
				.messageFlow("mf_VlidateJWT_Token").node("Compute");
